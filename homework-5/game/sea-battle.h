...
private:
private:
  static field_t delete_ships(field_t f);

  static bool check_kill(field_t &f, int i, int j);

  static bool check_win(field_t &f);

  field_t f1;
  field_t f2;

  std::shared_ptr<player_interface_t> my_player;
